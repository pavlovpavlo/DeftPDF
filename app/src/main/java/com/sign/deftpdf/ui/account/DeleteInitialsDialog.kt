...
class DeleteInitialsDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.dialog_delete_initials, container, false)
    ...
    companion object {
        private const val TAG = "DeleteInitialsDialog"
        private var dialog: DeleteInitialsDialog? = null
        private lateinit var confirmFunction: () -> Unit
        fun display(
            fragmentManager: FragmentManager,
            refreshResponse: () -> Unit
        ): DeleteInitialsDialog? {
            confirmFunction = refreshResponse
            dialog = DeleteInitialsDialog()
